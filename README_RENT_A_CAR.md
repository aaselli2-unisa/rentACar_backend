...
Progetto universitario — corso **SW Engineering for Secure Cloud Systems** (LM-66, UniSA) — **Andrea Aselli** · **Benedetto Pio Turino** · **Emanuele Pascale**. Applica il **Secure Software Development Lifecycle** (SSDLC) a **ExtendRent**, sistema REST API per il noleggio di autoveicoli: 29 vulnerabilità identificate in due round di audit OWASP, mitigate con patch chirurgiche e verificate con **403 test di sicurezza** (su 424 totali). Pipeline CI/CD con cinque gate di sicurezza automatici (GitGuardian, Snyk, Semgrep, SonarCloud, Trivy).

> Codice originale: [GitHub (branch master)](https://github.com/aaselli2-unisa/rentACar_backend/tree/master). Questo fork contiene tutte le patch di sicurezza.
...
![Class Diagram — Gerarchia degli Utenti](../TEXT_PROG/cd_users.png)
...
![Class Diagram — Gerarchia dei Veicoli](../TEXT_PROG/cd_vehicles.png)
...
![Class Diagram — Dominio del Noleggio e dei Pagamenti](../TEXT_PROG/cd_rental.png)
